# Praca Roczna - Techniki perswazyjne w polskim dyskursie parlamentarnym: anotacja manualna a klasyfikacja z wykorzystaniem modeli językowych
...
- `kalkulator_porownawczy.py` - liczy precision/recall/F1 anotacji ręcznej względem odpowiedzi modeli