Poniżej znajduje się pełna treść polecenia (ang. _prompt_) przekazanego czterem modelom językowym opisanym w rozdziale 3, w formie dosłownie identycznej z tą użytą w eksperymencie (plik źródłowy: `data/llm_results/prompt_template.md` w repozytorium projektu: #link("https://github.com/dominikoso/praca_roczna_3")).

#set text(size: 9pt)
````text
Jesteś klasyfikatorem tekstu wyspecjalizowanym w wykrywaniu technik perswazyjnych, zgodnie z taksonomią zadania SlavicNLP 2025 (BSNLP). Dostajesz cały dokument — polską wypowiedź sejmową — podzielony na 18 kolejnych akapitów (P01–P18). Twoim zadaniem jest ocenić KAŻDY akapit z osobna. (czytaj je w podanej kolejności, tak jak w oryginalnej mowie).

Dla każdego akapitu wskaż, które z poniższych 25 technik perswazyjnych występują (może być kilka naraz, albo żadna).

Lista technik z definicjami:

1. Name Calling or Labelling – przypisywanie nacechowanej, często obraźliwej lub deprecjonującej etykiety osobie, grupie, przedmiotowi lub działaniu (może to być też etykieta pozytywna, pożądana przez odbiorców).
2. Guilt by Association – atakowanie przeciwnika lub jego działania przez powiązanie go z inną grupą, działaniem lub pojęciem o wyraźnie negatywnych konotacjach.
3. Casting Doubt – podważanie charakteru lub cech osobistych kogoś/czegoś, by zakwestionować jego ogólną wiarygodność lub jakość.
4. Appeal to Hypocrisy – atakowanie reputacji celu przez zarzucenie mu hipokryzji lub niekonsekwencji.
5. Questioning the Reputation – atak przez mocne twierdzenia podważające charakter i moralną postawę celu, zamiast argumentu odnoszącego się do samego tematu.
6. Flag Waving – uzasadnianie idei przez odwołanie do dumy grupy albo podkreślanie korzyści dla tej konkretnej grupy.
7. Appeal to Authority – nadawanie wagi argumentowi lub informacji przez samo stwierdzenie, że pochodzi ona od uznanego autorytetu.
8. Appeal to Popularity – nadawanie wagi idei przez uzasadnienie, że rzekomo "wszyscy" się z nią zgadzają (albo "nikt" się nie sprzeciwia).
9. Appeal to Values – nadawanie wagi idei przez powiązanie jej z wartościami postrzeganymi przez odbiorców jako pozytywne.
10. Appeal to Fear, Prejudice – promowanie lub odrzucanie idei przez wzbudzenie w odbiorcach strachu lub niechęci wobec niej.
11. Strawman – stwarzanie wrażenia obalenia twierdzenia przeciwnika, podczas gdy w rzeczywistości nie odniesiono się do jego prawdziwego stanowiska, tylko zastąpiono je fałszywym.
12. Red Herring – odwracanie uwagi odbiorców od głównego wątku przez wprowadzenie innego, niezwiązanego tematu.
13. Whataboutism – próba zdyskredytowania stanowiska przeciwnika przez zarzucenie mu hipokryzji, bez bezpośredniego obalenia jego argumentu.
14. Causal Oversimplification – zakładanie jednej przyczyny tam, gdzie w rzeczywistości przyczyn jest więcej.
15. False Dilemma or No Choice – przedstawianie tylko dwóch możliwości tam, gdzie w rzeczywistości jest ich więcej; w skrajnej formie mówca dyktuje jedyne słuszne działanie, wykluczając inne opcje.
16. Consequential Oversimplification – twierdzenie, że jakieś pierwsze zdarzenie wywoła łańcuch kolejnych, coraz mniej prawdopodobnych skutków (efekt domina).
17. Slogans – krótkie, chwytliwe hasło, działające jak apel emocjonalny, często oparte na etykietowaniu lub stereotypach.
18. Conversation Killer – słowa lub frazy zniechęcające do krytycznego namysłu i dalszej dyskusji nad tematem.
19. Appeal to Time – argument oparty na przekonaniu, że "nadszedł czas" na dane działanie.
20. Loaded Language – użycie słów i zwrotów o silnym nacechowaniu emocjonalnym (pozytywnym lub negatywnym), by przekonać odbiorcę o słuszności argumentu.
21. Obfuscation, Intentional Vagueness, Confusion – celowe użycie słów niejasnych lub wieloznacznych, tak by odbiorca mógł je interpretować na wiele sposobów.
22. Exaggeration or Minimisation – przedstawianie czegoś w sposób nadmiernie wyolbrzymiony albo, przeciwnie, bagatelizowanie jego znaczenia.
23. Repetition – wielokrotne powtarzanie tej samej frazy w nadziei, że powtórzenie przekona odbiorcę.
24. Appeal to Pity – odwołanie do litości lub współczucia odbiorcy zamiast do argumentów rzeczowych.
25. False Equivalence – przedstawianie dwóch rzeczy jako równoważnych lub porównywalnych, mimo że różnią się w sposób logicznie lub etycznie istotny.

Oto dokument, akapit po akapicie:

### P01
Wicemarszałek Włodzimierz Czarzasty: Dziękuję serdecznie. Bardzo proszę panią posłankę Katarzynę Kotulę o przedstawienie uzasadnienia projektu ustawy zawartego w druku nr 177.

### P02
Poseł Katarzyna Kotula: Dziękuję bardzo. Panie Marszałku! Wysoka Izbo! Drogie, Szanowne Działaczki Ruchów Kobiecych i Działaczki Aborcyjne! Dokładnie miesiąc temu, kiedy marszałek Szymon Hołownia przesuwał debatę o aborcji, w warszawskim szpitalu Paulina starała się o przerwanie ciąży. Miała wszelką niezbędną dokumentację medyczną, która uprawniała ją do legalnej aborcji na podstawie obowiązującego prawa. Paulina miała zaświadczenie od specjalisty, które zapewniało, że jej zdrowie jest zagrożone. Ginekolodzy w warszawskim szpitalu nie chcieli niestety uznać tego zaświadczenia i rozpoczęła się gra na czas. Kto dłużej wytrzyma tę próbę sił? Kobieta w stanie zagrażającym zdrowiu czy szpital, instytucja, która powinna jej pomóc, a nie kłaść kłody pod nogi? To była gra życiem kobiety. Nie pierwsza, ale mam nadzieję, że jedna z ostatnich.
...
### P14
Zakaz aborcji zabija i nie likwiduje aborcji. Zakaz aborcji powoduje, że w polskich szpitalach nie ma dzisiaj bezpiecznej aborcji. Ale od 30 lat te aborcje się dzieją tylko dlatego, że poszczególne osoby znajdują sposób na to, żeby je zrobić. Ostatnie lata to zasługa grup nieformalnych i aktywistek działających w Polsce – to Aborcyjny Dream Team czy Aborcja bez Granic. Wiem, że jesteście, pozdrawiam was bardzo serdecznie i dziękuję za waszą pracę.
